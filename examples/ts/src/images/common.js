...
$(function() {
    ...
    $('body').bind('click', function (e) {
        ...
        if ($target.closest('.btn_menu').length > 0) {
            ...
            $('.area_sidebar').css('visibility', 'visible');
            $('.area_sidebar').css('opacity', '1');
            //$('.area_popup').hide();
            $('.area_popup').css('opacity', '0');
            setTimeout(function() { $('.area_popup').css('visibility', 'hidden'); }, 300);
            //$('body').css('overflow', 'hidden');
        } else if ($target.closest('.btn_search').length > 0) {
            //$('.area_sidebar').hide();
            $('.area_sidebar').css('opacity', '0');
            setTimeout(function() { $('.area_sidebar').css('visibility', 'hidden'); }, 300);
            $('.area_popup').css('visibility', 'visible');
            $('.area_popup').css('opacity', '1');
            //$('body').css('overflow', 'hidden');
